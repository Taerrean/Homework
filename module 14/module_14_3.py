...
b1 = InlineKeyboardButton(text = 'Product1', callback_data = 'product_purchase')
b2 = InlineKeyboardButton(text = 'Product2', callback_data = 'product_purchase')
b3 = InlineKeyboardButton(text = 'Product3', callback_data = 'product_purchase')
b4 = InlineKeyboardButton(text = 'Product4', callback_data = 'product_purchase')
buy_menu.row(b1, b2)
buy_menu.row(b3, b4)
