...
async def add_user(username: str = Path(min_length = 5, max_length = 20, description = 'Enter username', examples = ['Terrarum']),
               age: int = Path(ge = 18, le = 120, description= 'Enter age', examples = ['18'])):
...
async def update_params(username: str = Path(min_length = 5, max_length = 20, description = 'Enter username', examples = ['Terrarum']),
